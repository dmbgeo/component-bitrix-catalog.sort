...
<?foreach($arResult['ITEMS'] as $key => $value):?>
	<a class="sort_a <?=$value['ACTIVE']==true?"active":""?>" data-sort-active="<?=$value['ACTIVE']==true?1:0?>" data-sort-value='<?=$key?>' href=""><?=$value['NAME']?></a>
	<?=$key!==($arResult['SORT_FIELD_NUMBER']-1)?"&nbsp;•&nbsp;":""?> 
<?endforeach;?>
</div>
<?else:?>
<p style="font-size:16px;color:red;font-style:bold;text-align-center;"><?echo  GetMessage('NOT_RESULT');?></p>
<?endif;?>
